...
export const EmailSentState = ({ email, onResend, onChangeEmail, onTestVerification }) => {
  return (
    <div className="text-center space-y-6 font-montserrat">
      ...
      <div className="w-[80%] mx-auto">
        ...
        <p className="text-gray-800 mb-4">
          We've sent a verification link to <strong>{email}.</strong> Please check your inbox/spam and click the link to verify your account.
        </p>
      </div>
