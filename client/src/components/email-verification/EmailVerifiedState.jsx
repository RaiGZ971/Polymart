    ...
    <div className="text-center space-y-6 w-[80%] mx-auto">
      ...
      <div>
        ...
        <p className="text-gray-800 mb-4">
          Thank you for signing up for PolyMart! Your email{" "}
          <strong>{email}</strong> has been successfully verified.
        </p>
        <p className="text-gray-800">
          You can now proceed with your account setup and student verification
          to access full features of the app.
        </p>
      </div>
    </div>
  );
