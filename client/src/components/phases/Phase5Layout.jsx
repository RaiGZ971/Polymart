        ...
        <div className="w-full flex-1 flex flex-col gap-6">
          <div className="text-left space-y-1 pl-4">
            <div className="text-xl text-gray-800 font-semibold">
              Upload your Student ID Pictures
            </div>
            <span className="italic text-gray-400 text-base">
              Please upload clear photos of both sides of your Student ID
            </span>
          </div>
        ...
        <>
          <div className="text-left pl-4 space-y-2">
            <div className="font-bold">
              Thank you for uploading your COR and Student ID!{" "}
            </div>
            <p>
              Our team will verify your account within 3–5 working days. You’ll
              need a verified account to perform transactions and upload
              listings, but you can still browse the app while waiting.
            </p>
          </div>

          <div className="text-left pl-4">
            Hold on while we set things up for you...{" "}
            <i>You’ll be redirected shortly.</i>
          </div>
        </>
      )}
    </>
