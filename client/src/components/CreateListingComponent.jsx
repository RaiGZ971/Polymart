    ...
    return (
        <div className="w-full max-w-4xl bg-white rounded-xl shadow-glow p-8 relative">       
            <div className="space-y-6">
                ...
                <Container>
                    <div>
                        <h1 className="text-xl text-primary-red font-semibold">Choose your preferred payment method/s</h1>
                ...
                <Container>
                    <h1 className="text-xl text-primary-red font-semibold -mb-6">Choose your preferred meet-up location/s</h1>
                ...
                <Container>
                    <h1 className="text-xl text-primary-red font-semibold -mb-6">Choose available dates for meet-up/s</h1>
