...
export default function OrdersListingsComponent({
    ...
    // Set background and hover color based on role or status
    ...
    return (
        <div className="flex flex-col w-full group shadow-glow rounded-2xl hover:scale-105 transition-transform duration-300 ease-in-out cursor-pointer">
            ...
            <div className="w-full shadow-lg flex flex-row items-center p-8 rounded-t-2xl text-left">
                ...
                <div className="w-[50%] px-6">
                    <div className="mb-4">
                        <p className="text-sm font-semibold" style={{ color: statusTextColor }}>
                            {status}
                        </p>
                ...
                <div className="w-[30%] pl-6 border-l border-gray-200">
                    <p className="text-sm text-gray-800 font-semibold mb-2">Meet Up Details</p>
            ...
            {/* Bottom Bar: Action */}
            <div className={`text-sm rounded-b-2xl flex justify-end transition-colors duration-300 ease-in-out ${barBg} ${barHover}`}>
