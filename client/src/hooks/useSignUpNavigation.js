...
export const useSignUpNavigation = (emailVerificationStep, handleSubmit, formData, fieldConfig, phaseConfig) => {
      ...
      if (fieldDef.required) {
        ...
        if (fieldDef.type === 'file') {
          ...
          const isValidFile = value && (
            ...
            (typeof value === 'string' && value.length > 0 && value !== 'null' && value !== 'undefined') || // Valid string (URL, base64, etc.)
